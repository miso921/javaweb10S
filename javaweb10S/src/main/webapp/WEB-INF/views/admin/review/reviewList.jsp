...
<div class="container text-center">
  ...
  <div>
  	<h2 style="color:#760c0c;" class="text-center font-weight-bold">상품평</h2><hr id="hh" />
  		...
  		<c:forEach var="reviewVO" items="${vos}" varStatus="st">
				<tr>
					...
					<td><img src="${ctp}/review/${reviewVO.photo}" width="100px;" /></td>
				</tr>  		
			</c:forEach>
  		</table>
	  	<hr id="hh" />
	...
	<div class="text-center">
		<ul class="pagination justify-content-center">
		  <c:if test="${pageVO.pag > 1}">
		    <li class="page-item"><a href="admin//inquiryList?pag=1&pageSize=${pageVO.pageSize}" class="page-link text-secondary">◁◁</a></li>
		  </c:if>
