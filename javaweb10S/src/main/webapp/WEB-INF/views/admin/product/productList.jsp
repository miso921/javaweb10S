...
<head>
  <meta charset="UTF-8">
  <title>productList.jsp(관리자)</title>
...
<p><br /></p>
<div class="container">
	<span><a href="${ctp}/admin/product/productList" class="w3-button w3-ripple w3-brown mr-2">전체</a></span>
	<c:forEach var="parts" items="${parts}" varStatus="st">
		<span><a href="${ctp}/admin/product/productList?part=${parts}" class="w3-button w3-border w3-border-brown w3-round mr-2">${parts}</a></span>
	</c:forEach>
	<hr />
	<div class="row">
    ...
    <c:forEach var="vo" items="${productVOS}">
      <div class="col-md-4">
        <div style="text-align:center">
          <a href="${ctp}/admin/product/productContent?idx=${vo.idx}">
