...
<p><br/></p>
<div class="container">
  <h2 class="text-center">오 늘 의 레 시 피 검 색 목 록</h2>
      ...
      <tr>
        ...
        <td class="text-left">
          <c:if test="${vo.openSw == 'OK'}">
	          <a id="title" class="text-center" href="${ctp}/admin/todayRecipe/todayRecipeContent?idx=${vo.idx}&pag=${pageVO.pag}&pageSize=${pageVO.pageSize}">${vo.title}</a>
